...
<?php $this->load->view('tpl/sidebar'); ?> 
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <img src="<?php echo base_url();?>assets/images/animation-bg.jpg" class="js-animating-object img-responsive">
    ...
    <script type="text/javascript"> 
        ...
        $('#sb_ui').addClass('active');
        $('#sb_ui_animations').addClass('active');
